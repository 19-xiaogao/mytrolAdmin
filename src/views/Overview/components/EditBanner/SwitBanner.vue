    ...
    <div class="box">
        ...
        <div class="right-box">
            <div class="select-box">
                ...
                <icon-svg class="icon-add" icon="icon-bannerAdd" @click="addBannerClick"></icon-svg>
            </div>
            ...
            <div v-else>
                <div class="input-box">
                    <div class="input-title">
                        ...
                        <input v-model="currentParams.title" placeholder="请输入标题" type="text" />
                    </div>
                    <div class="input-title">
                        <span class="title-one">描述</span>
                        <span class="line"></span>
                        <input v-model="currentParams.decs" placeholder="请输入描述" type="text" />
                    </div>
                </div>
                <div class="input-url-save">
                    <input v-model="currentParams.imgUrl" placeholder="请输入图片链接" type="text" />
                    <a-button :loading="btnLoading" class="switch-imgUrl" type="primary"
                        >上传背景图片
